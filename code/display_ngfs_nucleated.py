...
cat_ngfs=cat_ngfs_nuc[np.isfinite(cat_ngfs_nuc['m_i'])]
...
plt.title('Sersic index distribution for Nucleated dwarfs', y=1.02)
plt.ylim(0,20)
fig.savefig('../figures/NGFS_dwarfs_nucleated_sersic_index.pdf', dpi=300)
...
fig.savefig('../figures/NGFS_dwarfs_nucleated_tile1_SORT_total_magnitude.png', dpi=300)
sys.exit()
