...
#==========================================================================================================================================#
magu_gE              = np.genfromtxt('NGFS_giantEs_fromKaren.dat'    ,dtype=float, comments='#', delimiter='', missing_values='...', skip_header=1, usecols = (14))    #
reff_kpc_gE          = np.genfromtxt('NGFS_giantEs_fromKaren.dat'    ,dtype=float, comments='#', delimiter='', missing_values='...', skip_header=1, usecols = (11))    #
magi_gE = magu_gE - 2.8364
reff_gE = reff_kpc_gE * 1e3
...
### NGFS giant ellitpicals
plt.scatter(magi_gE,reff_gE,                      s=300, marker='*',c='red', linewidths=0.5, edgecolor='#330000',zorder='5', facecolor='red',alpha=0.6)
#==========================================================================================================================================#                                                               
...
### add NGFS giants
plt.scatter(xalign,90, s=140, marker='*',c='red', linewidths=0.5, edgecolor='#330000',zorder='5', facecolor='red',alpha=0.6)
plt.text(xtextalign,90, r'NGFS giant ellitpicals', fontsize=ngfstxt, weight='heavy', verticalalignment='center', alpha=0.5)


# add Milky Way
plt.scatter(-21.3,2.5e3, s=300, marker='*', c='#ff9900', linewidths=0.9,  zorder='5', facecolor='#ff9900', edgecolor='#660000',alpha=0.75)
#plt.scatter(xalign,90, s=180, marker='*', c='#ff9900', linewidths=0.9,  zorder='5', facecolor='#ff9900', edgecolor='#660000',alpha=0.5)
#plt.text(xtextalign,90, r'Milky Way', fontsize=ngfstxt, weight='heavy', verticalalignment='center', alpha=0.5)
plt.annotate(r'Milky Way', xy=(-21.3,2.1e3), xycoords='data', alpha=0.5,
			xytext=(-2.0, -5.5e1), textcoords='offset points',size=12,
			arrowprops=dict(arrowstyle="fancy",fc="0.2", ec="none",
			connectionstyle="arc3,rad=-0.3",alpha=0.5,shrinkA=0.1),
			)	
...
plt.savefig('sequence_v4.pdf',format='pdf')
plt.show()
exit()
